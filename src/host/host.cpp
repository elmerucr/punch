...
//	}
	...
	vm_texture = nullptr;
	hud_texture = nullptr;
	create_vm_texture(true);
	create_hud_texture(true);
...
//	} else {
		SDL_SetWindowTitle(video_window, "punch");
//		// TODO: ?
//		//SDL_SetWindowIcon(SDL_Window *window, SDL_Surface *icon);
//	}
}

//void host_t::update_textures(E64::blitter_ic *vm_b, E64::blitter_ic *hud_b)
//{
...
//void host_t::update_screen(E64::blitter_ic *vm_b, E64::blitter_ic *hud_b)
//{
...
void host_t::create_vm_texture(bool linear_filtering)
{
...
void host_t::create_hud_texture(bool linear_filtering)
{
